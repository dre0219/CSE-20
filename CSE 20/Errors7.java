...
public class Errors7 {
	public static void main(String[] args) {
		...
		n2 = input.nextInt(); // Variable was already in use.

		System.out.print("Please enter 3 number: ");
		n3 = input.nextInt(); // Variable was already in use.

		System.out.print("Please enter 4 number: ");
		n4 = input.nextInt(); // Variable was already in use.
		...
		if (n0 > 0) {
			total = total + n0; //It forgot to add the total
			
		} if (n1 > 0) {
			total = total + n1; //It forgot to add the total
			count = count + 1;
		} if (n2 > 0) {
			total = total + n2;
			count = count + 1;
			...
			total = total + n3;
			count = count + 1;
		} if (n4 > 0) { //forgot the if and the n4 equation
			total = total + n4;
